        ...
        {toggle ?
          <div className="video-popup" onClick={() => setToggle(!toggle)}>
            <div className="video-popup-inner">
              <iframe className="video" title="CroSStab" allowFullScreen width="560" height="315" src="https://www.youtube.com/embed/m5xLC8FS-6k?autoplay=1&start=28" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
