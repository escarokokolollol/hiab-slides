    ...
    <StyledDiv>
      ...
      <div className="grid">
        ...
        <div className="right" onClick={() => setToggle(!toggle)}>
          <img className="video-image" src={ctcImg}  alt="video placeholder"/>
        ...
        {toggle ? 
          <div className="video-popup" onClick={ () => setToggle(!toggle)}>
            <div className="video-popup-inner">
              <iframe className="video" title="CTC" allowFullScreen width="560" height="315" src="https://www.youtube.com/embed/FJFmWjmH-ow" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
            </div>
